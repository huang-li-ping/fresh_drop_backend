<template>
    ...
    <div class="show_modal d-flex flex-column align-items-start gap-2" v-if="showModal">
        ...
        <label for="allergen"><input type="checkbox" id="allergen" v-model="allergenChecked"> 過敏原</label>
        <label for="dislike"><input type="checkbox" id="dislike" v-model="dislikeChecked"> 不喜歡的食物</label>
    ...
    data() {
        return {
            ...
            foodData: [
                ...
                { id: "51", name: "新鮮泰國香菜", allergen: "無", dislike: "無" },
                ...
                { id: "57", name: "西班牙海鮮燉飯底", allergen: "無", dislike: "無" },
                ...
                { id: "69", name: "越南河粉（即米粉）", allergen: "無", dislike: "無" },
                { id: "70", name: "雞肉或牛肉", allergen: "否", dislike: "是" },
                { id: "71", name: "雞湯或牛肉湯", allergen: "否", dislike: "是" },
                ...
                { id: "82", name: "莫札瑞拉乳酪", allergen: "是", dislike: "否" },
                { id: "83", name: "帕馬森乳酪", allergen: "是", dislike: "否" },
                { id: "84", name: "鮮魚片（如鮭魚、鱈魚等）", allergen: "是", dislike: "否" },
                { id: "85", name: "蔥", allergen: "無", dislike: "無" },
                { id: "86", name: "味噌", allergen: "否", dislike: "是" },
                { id: "87", name: "海帶（昆布）", allergen: "否", dislike: "是" },
                { id: "88", name: "温水", allergen: "無", dislike: "無" },
                { id: "89", name: "韓國辣椒醬（Gochujang）", allergen: "是", dislike: "否" },
                { id: "90", name: "韓國辣椒粉（Gochugaru）", allergen: "是", dislike: "否" },
                { id: "91", name: "雞湯或蔬菜湯", allergen: "無", dislike: "無" },
                { id: "92", name: "高湯（雞湯或蔬菜湯）", allergen: "無", dislike: "無" },
                { id: "93", name: "白酒（選擇性）", allergen: "是", dislike: "否" },
                { id: "94", name: "乾白葡萄酒", allergen: "是", dislike: "否" },
                { id: "95", name: "百里香", allergen: "無", dislike: "無" },
                { id: "96", name: "洋蔥湯包或香料袋", allergen: "否", dislike: "是" },
                { id: "97", name: "紅椒", allergen: "無", dislike: "無" },
                { id: "98", name: "磨碎的帕瑪森芝士（或其他起司）", allergen: "無", dislike: "無" },
                { id: "99", name: "薑", allergen: "無", dislike: "無" },
                { id: "100", name: "香茅", allergen: "無", dislike: "無" },
                { id: "101", name: "蜂蜜", allergen: "是", dislike: "否" },
                { id: "102", name: "魚肉或蝦肉", allergen: "是", dislike: "否" },
                { id: "103", name: "蔬菜（例如洋蔥、蒜頭、紅蘿蔔、馬鈴薯等）", allergen: "是", dislike: "否" },
                { id: "104", name: "葡萄牙香腸（可選）", allergen: "無", dislike: "無" },
                { id: "105", name: "蔬菜湯或魚湯", allergen: "是", dislike: "否" },
                ...
                { id: "112", name: "青蔥或歐芹", allergen: "否", dislike: "是" },
                { id: "113", name: "米醋", allergen: "無", dislike: "無" },
                { id: "114", name: "罐裝番茄", allergen: "無", dislike: "無" },
                { id: "115", name: "花椒粉", allergen: "無", dislike: "無" },
                { id: "116", name: "蔬菜湯或雞湯", allergen: "無", dislike: "無" },
                { id: "117", name: "玉米餅（可選）", allergen: "無", dislike: "無" },
                { id: "118", name: "雞肉或蝦肉", allergen: "是", dislike: "否" },
                { id: "119", name: "蔬菜（例如洋蔥、蘑菇、番茄等）", allergen: "否", dislike: "是" },
                { id: "120", name: "青檸葉", allergen: "無", dislike: "無" },
                { id: "121", name: "檸檬草", allergen: "否", dislike: "是" },
                { id: "122", name: "蔥段", allergen: "無", dislike: "無" },
                { id: "123", name: "雞湯或清水", allergen: "無", dislike: "無" },
                { id: "124", name: "青檸汁", allergen: "無", dislike: "無" },
                { id: "125", name: "擺盤所需的食材（例如，薄荷葉或檸檬片）", allergen: "無", dislike: "無" },
                { id: "126", name: "葡萄", allergen: "無", dislike: "無" },
                { id: "127", name: "香菜或泰國香菜（可選）", allergen: "無", dislike: "無" },
                { id: "128", name: "西芹", allergen: "無", dislike: "無" },
                { id: "129", name: "香菇", allergen: "無", dislike: "無" },
                { id: "130", name: "高湯或蔬菜湯", allergen: "無", dislike: "無" },
                { id: "131", name: "義大利細麵或通心粉", allergen: "無", dislike: "無" },
                { id: "132", name: "義大利香草調味料（如乾燥的羅勒、百里香、迷迭香）", allergen: "無", dislike: "無" },
                ...
                { id: "137", name: "雞肉或牛肉絲", allergen: "否", dislike: "是" },
                ...
                { id: "151", name: "帕馬森乾酪", allergen: "無", dislike: "無" },
